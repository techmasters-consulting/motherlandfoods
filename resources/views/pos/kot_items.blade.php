                    ...
                    @forelse ($orderItemList as $key => $item)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='menu-item-{{ $key . microtime() }}' wire:loading.class.delay='opacity-10'>
                            ...
                            <td class="p-2 whitespace-nowrap text-right">
                                <button class="rounded text-gray-800 dark:text-gray-400 border dark:border-gray-500 hover:bg-gray-200 dark:hover:bg-gray-900/20 p-2" wire:click="deleteCartItems('{{ $key }}')">
    ...
    <div>
        ...
        <div class="h-auto pb-4 pt-3 select-none text-center w-full">
            <div class="flex gap-3">
                ...
                <button class="rounded bg-gray-700 text-white  w-full p-2" wire:click="saveOrder('kot','bill','payment')">
